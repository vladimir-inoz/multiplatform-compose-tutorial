...
import cupcake.composeapp.generated.resources.promo_name
...
import org.jetbrains.nav_cupcake.ui.PromoScreen
...
fun CupcakeApp(
    ...
    LaunchedEffect(uiState.showPromo) {
        if (uiState.showPromo) {
            viewModel.setPromoOpened()
            navController.navigate(route = CupcakeScreen.Promo.name)
        }
    }
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(route = CupcakeScreen.Promo.name) {
                PromoScreen()
            }
        }
    }
